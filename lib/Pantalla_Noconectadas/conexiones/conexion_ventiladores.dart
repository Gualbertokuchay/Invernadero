...
class Ventilacion extends StatefulWidget {
  const Ventilacion({Key? key}) : super(key: key);

  @override
  State<Ventilacion> createState() => _VentilacionState();
}

class _VentilacionState extends State<Ventilacion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Panel de Ventilacion"), // Texto centrado en el AppBar
        ...
        child: _data.isNotEmpty
            ? GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2,
                  childAspectRatio:
                      1.0, // Esto hace que las tarjetas sean cuadradas
                ),
